 ...
 *
 * @returns The core table name (e.g., "vericlause-core-dev")
 ...
 *
 * @returns The base table name (e.g., "vericlause-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "vericlause-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "vericlause-app-realtime-dev")
