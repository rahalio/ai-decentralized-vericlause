/**
 * ContractProjects Domain
 *
 * Barrel export for contract-projects service, types, hooks, and view models.
 *
 * Architecture Rules:
...
// ============================================================================
export { contract-projectsService } from './contract-projects.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { contract-projectsFacade } from './facade';
...
} from './contract-projects.api-types';
