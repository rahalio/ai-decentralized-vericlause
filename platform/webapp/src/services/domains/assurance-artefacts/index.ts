/**
 * AssuranceArtefacts Domain
 *
 * Barrel export for assurance-artefacts service, types, hooks, and view models.
 *
 * Architecture Rules:
...
// ============================================================================
export { assurance-artefactsService } from './assurance-artefacts.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { assurance-artefactsFacade } from './facade';
...
} from './assurance-artefacts.api-types';
